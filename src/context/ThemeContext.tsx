...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  const loadTenant = async () => {
    ...
    try {
      ...
      const isMainDomain = host.includes('infinito.com') || host.includes('platform.com') || host.includes('yourdomain') || host.includes('vercel.app') || host.includes('serveraa.in'); // Fallbacks
