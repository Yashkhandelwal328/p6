  ...
  return (
    <div className="space-y-6 animate-fade-in p-6">
      ...
      <div className="mt-8 bg-surface p-6 rounded-2xl border border-accent shadow-sm">
         <h2 className="text-xl font-bold text-primary mb-4">All Tenants</h2>
         <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-accent text-sm text-primary/60">
                ...
                {restaurantsList.map(r => (
                  <tr key={r.id} className="hover:bg-primary/5 transition-colors">
                    <td className="py-4 px-4 font-medium text-primary">
                      {r.name}
                      <p className="text-xs text-primary/60 font-normal">{r.restaurant_code}</p>
                    </td>
                    ...
                    <td className="py-4 px-4 text-sm text-primary/80">
