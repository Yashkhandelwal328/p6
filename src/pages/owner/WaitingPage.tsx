      ...
      <div className="max-w-4xl w-full grid md:grid-cols-2 gap-8 items-start">
        ...
        <div className="card-luxury p-8">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 space-y-3">
            ...
            <a href="mailto:support@serveraa.com" className="flex items-center gap-2 text-sm text-ink-600 hover:text-nirvana-300 transition-colors">
              <Mail className="w-4 h-4" /> support@serveraa.com
            </a>
